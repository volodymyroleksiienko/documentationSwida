        ...
        for(int j=0; j<deliveryDocumentation.size();j++){
            for(int i = 0; i<deliveryDocumentation.get(j).getProductList().size();i++){
                ...
                Row row;
                    ...
                    row.createCell(2).setCellValue(product.getSizeOfHeight());
                    row.createCell(3).setCellValue(product.getSizeOfWidth());
                    row.createCell(4).setCellValue(product.getSizeOfLong());
                    row.createCell(5).setCellValue(product.getCountOfDesk());
                    row.createCell(6).setCellValue(product.getExtent());
